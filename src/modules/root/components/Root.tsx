    ...
    <div className="py-3">
      <div className="pb-2 rounded-lg shadow-smooth shadow-smooth-hover">
            ...
            <div className="pl-2 pb-2">
              <div className="absolute top-24 border-4 rounded-full">
                {/* <Image
                  ...
                  unoptimized
                /> */}
              <div className="w-40 h-40 rounded-full bg-red-500 flex items-center justify-center text-white font-bold text-7xl uppercase">
                NC
              </div>
              </div>
            </div>
        ...
        <div className="px-4 pt-4 flex justify-between flex-col md:flex-row">
          <div className="pb-4">
            <strong className="text-black text-xl">Naresh Chudasama</strong>
          ...
          <div className=" text-sm sm:text-lg sm:font-bold flex flex-col justify-center">
            <a
              href="mailto:nareshchudasama206@gmail.com"
            ...
            >
              ...
              <p className="px-2">nareshchudasama206@gmail.com</p>
            </a>

            <a
              href="tel:+917096916959"
            ...
            >
              ...
              <p className="inline px-2">+91 7096916959</p>
            </a>
          </div>
        </div>
